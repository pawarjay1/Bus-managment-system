...
if(isset($_GET['delete'])){
    ...
    $delete_users = mysqli_query($conn,"DELETE FROM `message` WHERE id = '".$delete_id."'");
...
<body>
    <div class="slidebar">
        ...
        <ul class="nav_list">
            ...
            <li>
                <a href="admin_message.php" class="active">
    ...
    <div class="main">
        ...
        ?>
            <div class="account_box">
                    ...
                    <h3>mobile no:<?php echo $fetch['mobile_no']; ?></h3> 
                    <h3>message:<?php echo $fetch['feedback']; ?></h3> 
                    <a href="admin_message.php?delete=<?= $fetch['id']; ?>" onclick="return confirm('delete this message?');">delete</a>
            </div>
        <?php } ?>
    </div>
</body>
